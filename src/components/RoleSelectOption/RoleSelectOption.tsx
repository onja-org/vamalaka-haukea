...
import darkPolygonBg from '../../assets/dark-polygon.svg'
import whitePolygonBg from '../../assets/white-polygon.svg'
import { ReactComponent as BuyerIcon } from '../../assets/user.svg'
import { ReactComponent as SellerIcon } from '../../assets/briefcase.svg'
...
export const RoleSelectOption: React.FC<RoleSelectOptionProps> = ({
	label,
	text,
	setRole,
	role,
